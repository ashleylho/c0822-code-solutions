...
function renderPokemon(pokemon) {
  ...
  newTextDiv.className = 'pokemon-card-text';
  pokemonDiv.appendChild(newTextDiv);
  ...
  newTextDiv.appendChild(pokemonName);
  ...
  newTextDiv.appendChild(pokemonNumber);
  ...
  newTextDiv.appendChild(pokemonDescription);
  return newDiv;
}
